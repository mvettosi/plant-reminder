...
class NotificationDaoTest {
  ...
  fun testInsertGetAllNotifications() = runTest {
    ...
    val notifications =
        listOf(
            TestData.notificationEntity.copy(
                displayedTime = TestData.notificationEntity.displayedTime.plusDays(1)),
            TestData.notificationEntity.copy(
                displayedTime = TestData.notificationEntity.displayedTime.plusDays(2)),
            TestData.notificationEntity.copy(
                displayedTime = TestData.notificationEntity.displayedTime.plusDays(3)))
