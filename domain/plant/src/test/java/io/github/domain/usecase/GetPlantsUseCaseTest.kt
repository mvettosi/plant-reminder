  ...
  fun testGetUpcomingPlants() = runTest {
    ...
    val upcomingPlants =
        listOf(
            ...
            TestData.basePlant.copy(
                id = 4, nextWaterDate = TestData.now.plusDays(1), deleted = true),
        )
  ...
  fun testGetForgotToWaterPlants() = runTest {
    ...
    val forgotToWaterPlants =
        listOf(
            ...
            TestData.basePlant.copy(
                id = 4, nextWaterDate = TestData.now.plusDays(2), deleted = true),
        )
  ...
  fun testGetHistoryPlants() = runTest {
    ...
    val historyPlants =
        listOf(
            TestData.basePlant.copy(
                id = 1,
                lastWaterDate = TestData.now.minusDays(1),
                nextWaterDate = TestData.now.minusDays(3)),
            TestData.basePlant.copy(
                id = 2,
                lastWaterDate = TestData.now.minusDays(2),
                nextWaterDate = TestData.now.minusDays(1)),
            TestData.basePlant.copy(
                id = 3,
                lastWaterDate = LocalDateTime.MIN,
                nextWaterDate = TestData.now.plusDays(4)),
            TestData.basePlant.copy(
                id = 4,
                lastWaterDate = TestData.now.minusDays(2),
                nextWaterDate = TestData.now.plusDays(3)),
            TestData.basePlant.copy(
                id = 5, nextWaterDate = TestData.now.plusDays(1), deleted = true),
        )
